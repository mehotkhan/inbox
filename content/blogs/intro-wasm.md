...
۱- زبان های کامپایلیری که کد های نوشته شده ابتدا توسط کامپایلر به زبان سطح ماشین (assembly )  تبدیل میشوند و سپس این فایل های باینری توسط ماشین اجرا میشوند .زبان هایی مثل C, C++ , GO و ...
